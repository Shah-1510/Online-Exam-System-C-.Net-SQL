<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddTeacher.aspx.cs" Inherits="ProjectX.Admin.AddTeacher" %>
...
<head runat="server">
    <title>Add Teachers - Online Examination System</title>
                                ...
                                <div class="col-xl-7">
                                    <div class="card">
                                        ...
                                        <div class="btn-group bg-danger">
                                            <asp:Button ID="btn_panelexamlist" runat="server" Text="Add Teacher" CssClass="btn bt1 btn-info" BorderStyle="None" CausesValidation="False" />
                                        </div>
                                        ...
                                        <div class="card-body pt-3">
                                            <div class="tab-content pt-3">
                                                ...
                                                <div class="row mb-3">
                                                    <label for="name" class="col-md-4 col-lg-3 col-form-label addnotifyLabel">Name</label>
                                                    <div class="col-md-8 col-lg-9">
                                                        <asp:RequiredFieldValidator ID="rfv1" ErrorMessage="*" Display="Dynamic" Font-Bold="true" Font-Size="15px" ControlToValidate="name" runat="server" />
                                                        <asp:TextBox class="form-control txtbxN" ID="name" runat="server" />
                                                    </div>
                                                </div>

                                                <div class="row mb-3">
                                                    <label for="email" class="col-md-4 col-lg-3 col-form-label addnotifyLabel">Email</label>
                                                    <div class="col-md-8 col-lg-9">
                                                        <asp:RequiredFieldValidator ID="rfv2" ErrorMessage="*" Display="Dynamic" Font-Bold="true" Font-Size="15px" ControlToValidate="email" runat="server" />
                                                        <asp:Label ID="errorMsg" ForeColor="Red" Text=" " runat="server" Font-Size="12px"/>
                                                        <asp:TextBox type="email" class="form-control txtbxN" ID="email" OnTextChanged="EmailCheck" AutoPostBack="true" runat="server" />
                                                    </div>
                                                </div>

                                                <div class="row mb-3">
                                                    <label for="pass" class="col-md-4 col-lg-3 col-form-label addnotifyLabel">Password</label>
                                                    <div class="col-md-8 col-lg-9">
                                                        <asp:RequiredFieldValidator ID="rfv3" ErrorMessage="*" Display="Dynamic" Font-Bold="true" Font-Size="15px" ControlToValidate="pass" runat="server" />
                                                        <asp:TextBox type="password" class="form-control txtbxN" ID="pass" runat="server" />
                                                    </div>
                                                </div>

                                                <div class="row mb-3">
                                                    <label for="selectCourse" class="col-md-4 col-lg-3 col-form-label addnotifyLabel">Select Course</label>
                                                    <div class="col-md-8 col-lg-9">
                                                        <asp:RequiredFieldValidator ID="rfv4" runat="server" ErrorMessage="*" Display="Dynamic" Font-Bold="true" Font-Size="15px" ControlToValidate="selectCourse" ForeColor="red"></asp:RequiredFieldValidator>
                                                        <asp:DropDownList ID="selectCourse" runat="server" CssClass="form-control txtbxN" DataTextField="CourseName">
                                                        </asp:DropDownList>                 
                                                    </div>
                                                </div>

                                                <div class="text-center">
                                                    <asp:Button Text="Save" type="submit" class="btn1 btn-primary" ID="savebtn" OnClick="add" runat="server" />
                                                </div>

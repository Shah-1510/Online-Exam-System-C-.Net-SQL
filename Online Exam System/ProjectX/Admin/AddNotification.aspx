<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddNotification.aspx.cs" Inherits="ProjectX.Admin.AddNotification" %>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body pt-3">
                                            <div class="tab-content pt-3">
                                                ...
                                                <div class="row mb-3">
                                                    <label for="selectCategory" class="col-md-4 col-lg-3 col-form-label addnotifyLabel">To</label>
                                                    <div class="col-md-8 col-lg-9">
                                                        <asp:RequiredFieldValidator ID="rfv4" runat="server" ErrorMessage="*" Display="Dynamic" Font-Bold="true" Font-Size="15px" ControlToValidate="selectCategory" ForeColor="red" InitialValue="-1" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                                        <asp:DropDownList ID="selectCategory" runat="server" CssClass="form-control txtbxN">

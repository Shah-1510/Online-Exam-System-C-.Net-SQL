<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Course.aspx.cs" Inherits="ProjectX.Student.Course" %>
...
<head runat="server">
    <title>Course - Online Examination System</title>
                ...
                <div class="content-wrapper">
                        ...
                        <div class="col-md-12 grid-margin">
                            <div class="row">
                                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                                    <h3 class="font-weight-bold"><asp:Label Text="" ID="CourseLabel" runat="server" /></h3>
                    ...
                    <section class="section dashboard">
                        <div class="row">
                                            ...
                                            <div class="col-xl-6">
                                                <div class="card1 info-card sales-card">
                                                    <div class="card-body1">
                                                        <h5 class="card-title1">- <%#Eval("Name") %></h5>
                                                        ...
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <div class="ps-3 enterLink">
                                                                <h6>Passing Marks: <%# Eval("PassingMarks") %></h6>
                                                            </div>
                                                        </div>
                                                        <asp:HyperLink NavigateUrl='<%# "~/Student/Quiz.aspx?qid=" + Eval("Q_ID")%>' class="courseLink" runat="server">
                            ...
                            <form runat="server">
                                <div class="stretch-card noQuizCard" id="errorLabel" runat="server">
                                    <div class="col-xl-4">
                                        <div class="card1 info-card sales-card">
                                            <div class="card-body1">
                                                <i class="bi bi-x-circle-fill crossIcon"></i>
                                                <h5 class="card-title1">
                                                    <asp:Label Text="" ID="noQuiz" runat="server" /></h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>

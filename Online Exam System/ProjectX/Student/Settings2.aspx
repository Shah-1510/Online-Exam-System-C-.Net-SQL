<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Settings2.aspx.cs" Inherits="ProjectX.Student.Settings2" %>
...
<head runat="server">
    <title>Change Password - Online Examination System</title>
                                    ...
                                    <div class="card">
                                        <div class="card-body pt-3">
                                            <ul class="nav nav-tabs nav-tabs-bordered">
                                                <li class="nav-item">
                                                    <a class="settingsBtn" href="/Student/Settings1.aspx"><button class="nav-link nav1" data-bs-toggle="tab">Edit Profile</button></a>
                                                </li>
                                                <li class="nav-item">
                                                    <button class="nav-link active nav1" data-bs-toggle="tab" data-bs-target="#profile-change-password">Change Password</button>
                                                </li>
                                            </ul>
                                            ...
                                            <div class="tab-content pt-2">
                                                ...
                                                <div class="tab-pane show active fade pt-3" id="profile-change-password">
                                                    ...
                                                    <form runat="server">
                                                        ...
                                                        <div class="row mb-3">
                                                            <label for="currentPassword" class="col-md-4 col-lg-3 col-form-label changePasswordLabel currentPass">Current Password</label>
                                                            <div class="col-md-8 col-lg-9">
                                                                <asp:Label ID="errorMsg" ForeColor="Red" Text=" " runat="server" Font-Size="13px"/>
                                                                <asp:RequiredFieldValidator ErrorMessage="*" ControlToValidate="currentPassword" Display="Dynamic" ID="rfv1" ForeColor="red" Font-Bold="true" Font-Size="Larger" runat="server" />                                                              
                                                                <asp:TextBox type="password" class="form-control" id="currentPassword" OnTextChanged="PasswordCheck" AutoPostBack="true" runat="server" />
                                                            </div>
                                                        </div>

                                                        <div class="row mb-3">
                                                            <label for="newPassword" class="col-md-4 col-lg-3 col-form-label changePasswordLabel">New Password</label>
                                                            <div class="col-md-8 col-lg-9">
                                                                <asp:RequiredFieldValidator ErrorMessage="*" ControlToValidate="newPassword" Display="Dynamic" ID="rfv2" ForeColor="red" Font-Bold="true" Font-Size="Larger" runat="server" />                                                    
                                                                <asp:TextBox type="password" class="form-control" id="newPassword" runat="server" />
                                                            </div>
                                                        </div>

                                                        <div class="row mb-3">
                                                            <label for="renewPassword" class="col-md-4 col-lg-3 col-form-label changePasswordLabel re-enterPass">Re-enter Password</label>
                                                            <div class="col-md-8 col-lg-9">
                                                                <asp:RequiredFieldValidator ErrorMessage="*" ControlToValidate="renewPassword" Display="Dynamic" ID="rfv3" ForeColor="red" Font-Bold="true" Font-Size="Larger" runat="server" /> 
                                                                <asp:CompareValidator ErrorMessage="* Password do not match" ControlToValidate="renewPassword" ControlToCompare="newPassword" runat="server" Display="Dynamic" ForeColor="Red" Font-Size="13px" ID="errorMsg1"/>
                                                                <asp:TextBox type="password" class="form-control" id="renewPassword" runat="server" />
                                                            </div>
                                                        </div>

                                                        <div class="text-center">
                                                            <asp:Button Text="Change Password" type="submit" onclick="ChangePassword" id="changepassbtn" class="btn btn-primary btn1" runat="server" />
                                                        </div>

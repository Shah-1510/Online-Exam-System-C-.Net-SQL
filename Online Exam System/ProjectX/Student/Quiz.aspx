<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Quiz.aspx.cs" Inherits="ProjectX.Student.Quiz" %>
                        ...
                        <div class="col-md-12 grid-margin">
                            <div class="row">
                                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                                    <h3 class="font-weight-bold qlabel"><asp:Label Text="" ID="QuizLabel" runat="server" /></h3>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <form runat="server">
                                <div class="stretch-card">
                                    <div class="col-xl-11">
                                        <div class="card1 info-card sales-card" id="card" runat="server">
                                            <div class="card-body1">
                                                <h5 class="card-title1">- Attempt All The Questions!</h5>
                                                <hr class="headLine"/>

                                                <asp:TextBox ID="getstringuser" runat="server" Visible="false"></asp:TextBox>

                                                <asp:GridView ID="Questions" AutoGenerateColumns="False" GridLines="None" runat="server">
                                                    <Columns>
                                                        <asp:TemplateField>
                                                            <ItemTemplate>

                                                                <div class="ps-3 enterLink quesBody">
                                                                    <asp:Label ID="lblid" runat="server" Text='<%# Eval("Ques_ID") %>' Visible="false"></asp:Label>
                                                                    <asp:Label ID="quesLabel" runat="server" Text='<%# Eval("Ques") %>'></asp:Label>
                                                                    <br />
                                                                    <div class="rbtnBody">
                                                                        <asp:RadioButton CssClass="rbtn" GroupName="a" Text='<%# Eval("OptOne") %>' ID="optionOne" Style="margin-right: 10px;" runat="server" />
                                                                        <br />
                                                                        <asp:RadioButton CssClass="rbtn" GroupName="a" Text='<%# Eval("OptTwo") %>' ID="optionTwo" runat="server" />
                                                                        <br />
                                                                        <asp:RadioButton CssClass="rbtn" GroupName="a" Text='<%# Eval("OptThree") %>' ID="optionThree" runat="server" />
                                                                        <br />
                                                                        <asp:RadioButton CssClass="rbtn" GroupName="a" Text='<%# Eval("OptFour") %>' ID="optionFour" runat="server" />
                                                                    </div>
                                                                    <hr class="quesLine"/>
                                                                </div>
                                                ...
                                                <asp:Button Text="Submit" type="submit" ID="btnSubmit" CssClass="btn btn-primary" OnClick="saveQuiz" runat="server" />
                                ...
                                <div class="stretch-card noQuesCard" id="errorLabel" runat="server">
                                    <div class="col-xl-4">
                                        <div class="card1 info-card sales-card">
                                            <div class="card-body1">
                                                <i class="bi bi-x-circle-fill crossIcon"></i>
                                                <h5 class="card-title1">
                                                    <asp:Label Text="" ID="noQuestions" runat="server" /></h5>
                                            </div>
                                        </div>
                                    </div>
                                </div>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditQuestion.aspx.cs" Inherits="ProjectX.Teacher.EditQuestion" %>
...
<head runat="server">
    <title>Edit Question - Online Examination System</title>
    ...
    <style>
        ...
        #rfv0, #rfv1, #rfv2, #rfv3, #rfv4, #rfv5, #rfv6{
            position: absolute;
            top: 20px;
            right: 100px;
            z-index: 200;
                        ...
                        <div class="col-md-12 grid-margin">
                            <div class="row">
                                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                                    <h3 class="font-weight-bold">Add Questions</h3>
                                ...
                                <div class="col-xl-10">
                                    <div class="card">
                                        ...
                                        <div class="btn-group bg-danger">
                                            <asp:Button ID="btn_paneleditquestion" runat="server" Text="Edit Question" CssClass="btn bt1 btn-info" BorderStyle="None" CausesValidation="False" BackColor="#343A40" />
                                        </div>
                                        ...
                                        <div class="card-body pt-3">
                                            <div class="tab-content pt-3">
                                                ...
                                                <div class="row mb-3">
                                                    <label for="selectQuiz" class="col-md-4 col-lg-3 col-form-label addLabel">Select Quiz</label>
                                                    <div class="col-md-8 col-lg-9">
                                                        <asp:RequiredFieldValidator ID="rfv0" runat="server" ErrorMessage="*" Display="Dynamic" Font-Bold="true" Font-Size="15px" ControlToValidate="selectQuiz" ForeColor="red" InitialValue="-1" SetFocusOnError="true"></asp:RequiredFieldValidator>
                                                        <asp:DropDownList ID="selectQuiz" runat="server" CssClass="form-control txtbxN" DataTextField="Name" DataValueField="Q_ID">
                                                        </asp:DropDownList>                 
                                                    </div>
                                                </div>

                                                <div class="row mb-3">
                                                    <label for="question" class="col-md-4 col-lg-3 col-form-label addLabel">Question</label>
                                                    <div class="col-md-8 col-lg-9">
                                                        <asp:RequiredFieldValidator ID="rfv1" ErrorMessage="*" Display="Dynamic" Font-Bold="true" Font-Size="15px" ControlToValidate="question" runat="server" />
                                                        <asp:TextBox TextMode="MultiLine" Height="150px" class="form-control txtbxN" ID="question" runat="server" />
                                                    </div>
                                                </div>

                                                <div class="row mb-3">
                                                    <label for="optA" class="col-md-4 col-lg-3 col-form-label addLabel">Option A</label>
                                                    <div class="col-md-8 col-lg-9">
                                                        <asp:RequiredFieldValidator ID="rfv2" ErrorMessage="*" Display="Dynamic" Font-Bold="true" Font-Size="15px" ControlToValidate="optA" runat="server" />
                                                        <asp:TextBox class="form-control txtbxN" ID="optA" runat="server" />
                                                    </div>
                                                </div>

                                                <div class="row mb-3">
                                                    <label for="optB" class="col-md-4 col-lg-3 col-form-label addLabel">Option B</label>
                                                    <div class="col-md-8 col-lg-9">
                                                        <asp:RequiredFieldValidator ID="rfv3" ErrorMessage="*" Display="Dynamic" Font-Bold="true" Font-Size="15px" ControlToValidate="optB" runat="server" />
                                                        <asp:TextBox class="form-control txtbxN" ID="optB" runat="server" />
                                                    </div>
                                                </div>

                                                <div class="row mb-3">
                                                    <label for="optC" class="col-md-4 col-lg-3 col-form-label addLabel">Option C</label>
                                                    <div class="col-md-8 col-lg-9">
                                                        <asp:RequiredFieldValidator ID="rfv4" ErrorMessage="*" Display="Dynamic" Font-Bold="true" Font-Size="15px" ControlToValidate="optC" runat="server" />            
                                                        <asp:TextBox class="form-control txtbxN" ID="optC" runat="server" />
                                                    </div>
                                                </div>

                                                <div class="row mb-3">
                                                    <label for="optD" class="col-md-4 col-lg-3 col-form-label addLabel">Option D</label>
                                                    <div class="col-md-8 col-lg-9">
                                                        <asp:RequiredFieldValidator ID="rfv5" ErrorMessage="*" Display="Dynamic" Font-Bold="true" Font-Size="15px" ControlToValidate="optD" runat="server" />
                                                        <asp:TextBox class="form-control txtbxN" ID="optD" runat="server" />
                                                    </div>
                                                </div>

                                                <div class="row mb-3">
                                                    <label for="correctAnswer" class="col-md-4 col-lg-3 col-form-label addLabel">Correct Answer</label>
                                                    <div class="col-md-8 col-lg-9">
                                                        <asp:RequiredFieldValidator ID="rfv6" ErrorMessage="*" Display="Dynamic" Font-Bold="true" Font-Size="15px" ControlToValidate="correctAnswer" runat="server" />
                                                        <asp:RadioButtonList CssClass="rbl" ID="correctAnswer" runat="server" RepeatDirection="Horizontal" RepeatLayout="Table" CellPadding="10">
                                                ...
                                                <div class="offset-2">
                                                    <div class="text-center">
                                                        <asp:Button Text="Update" type="submit" class="btn1 btn-primary" ID="savebtn" BorderStyle="None" ForeColor="White" OnClick="updateQues" runat="server" />
                                                    </div>
                                                </div>

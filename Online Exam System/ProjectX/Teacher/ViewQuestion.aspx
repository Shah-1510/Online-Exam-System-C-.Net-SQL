<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewQuestion.aspx.cs" Inherits="ProjectX.Teacher.ViewQuestion" %>
...
<head runat="server">
    <title>View Question - Online Examination System</title>
                        ...
                        <div class="col-md-12 grid-margin">
                            <div class="row">
                                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                                    <h3 class="font-weight-bold">View Questions</h3>
                                ...
                                <div class="col-xl-11">
                                    <div class="card">
                                        ...
                                        <div class="btn-group bg-danger">
                                            <asp:Button ID="btn_panelexamquestion" runat="server" Text="Questions" CssClass="btn bt1 btn-info" BorderStyle="None" CausesValidation="False" BackColor="#343A40" />
                                        </div>
                                        ...
                                        <div class="card-body pt-3">
                                            ...
                                            <div class="table-responsive">
                                                ...
                                                <asp:GridView BorderWidth="1px" BorderColor="#cac1c1"  ID="quizQuestions" runat="server" GridLines="None" CssClass="table table-bordered" AutoGenerateColumns="False" AllowPaging="True" OnPageIndexChanging="gridview_examquestion_PageIndexChanging" OnRowCommand="gridview_examquestion_RowCommand" PageSize="5">
                                                    <Columns>

                                                        <asp:TemplateField HeaderText="Quiz Topic">
                                                            <ItemTemplate>
                                                       ...
                                                       <asp:TemplateField HeaderText="A">
                                                            <ItemTemplate>
                                                                <asp:Label ID="Label3" runat="server" Text='<%# Bind("OptOne") %>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>

                                                        <asp:TemplateField HeaderText="B">
                                                            <ItemTemplate>
                                                                <asp:Label ID="Label4" runat="server" Text='<%# Bind("OptTwo") %>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>

                                                        <asp:TemplateField HeaderText="B">
                                                            <ItemTemplate>
                                                                <asp:Label ID="Label5" runat="server" Text='<%# Bind("OptThree") %>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>

                                                        <asp:TemplateField HeaderText="D">
                                                            <ItemTemplate>
                                                                <asp:Label ID="Label6" runat="server" Text='<%# Bind("OptFour") %>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        ...
                                                        <asp:TemplateField HeaderText="Options">
                                                            <ItemTemplate>
                                                                ...
                                                                <asp:HyperLink ID="btn_editexam" runat="server" CssClass="btn bt" BackColor="#343A40" BorderStyle="None" ForeColor="White" NavigateUrl='<%# "/Teacher/EditQuestion.aspx?quesid=" + Eval("Ques_ID") %>'>
                                                                    <i class="bi bi-pencil-square" aria-hidden="true"></i> Edit
                                                                </asp:HyperLink>

                                                                <asp:LinkButton ID="btn_deleteexam" runat="server" CssClass="btn bt" BackColor="#343A40" BorderStyle="None" ForeColor="White" CommandArgument='<%# Eval("Ques_ID") %>' CommandName="delQuestion">

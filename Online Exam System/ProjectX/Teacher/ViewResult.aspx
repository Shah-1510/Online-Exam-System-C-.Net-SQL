<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewResult.aspx.cs" Inherits="ProjectX.Teacher.ViewResult" %>
                                ...
                                <div class="col-xl-11">
                                    <div class="card" runat="server">
                                        ...
                                        <div class="btn-group bg-danger">
                                            <asp:Button ID="btn_panelresult" runat="server" Text="Results" CssClass="btn bt1 btn-info" BorderStyle="None" CausesValidation="False" BackColor="#343A40" />
                                        </div>
                                        ...
                                        <div class="card-body text-center mb-3">
                                            ...
                                            <div class="table-responsive">
                                                ...
                                                <asp:GridView BorderWidth="1px" BorderColor="#cac1c1" ID="myResult" runat="server" GridLines="None" AllowPaging="True" AutoGenerateColumns="False" CssClass="table table-bordered" OnPageIndexChanging="gridmyresult_PageIndexChanging" PageSize="8">
                                                    <Columns>
                                                        <asp:BoundField DataField="Name" HeaderText="Quiz Topic" />
                                                        <asp:BoundField DataField="Date" DataFormatString="{0:M/d/yy}" HeaderText="Quiz Date" />

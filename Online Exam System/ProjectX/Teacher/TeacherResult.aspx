<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TeacherResult.aspx.cs" Inherits="ProjectX.Teacher.TeacherResult" %>
...
<head runat="server">
    <title>Results - Online Examination System</title>
                                ...
                                <div class="col-xl-11">
                                    <div class="card" runat="server">
                                        ...
                                        <div class="btn-group bg-danger">
                                            <asp:Button ID="btn_panelresult" runat="server" Text="Students" CssClass="btn bt1 btn-info" BorderStyle="None" CausesValidation="False" BackColor="#343A40" />
                                        </div>
                                        ...
                                        <div class="card1 text-center mb-3">
                                            <div class="card-body pt-3">
                                                ...
                                                <div class="table-responsive">
                                                    <asp:GridView BorderWidth="1px" BorderColor="#cac1c1" ID="allStudents" runat="server" GridLines="None" AllowPaging="True" AutoGenerateColumns="False" CssClass="table table-bordered" PageSize="8" OnPageIndexChanging="gridallstudents_PageIndexChanging">
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="Result">
                                                                ...
                                                                <ItemTemplate>
                                                                    <asp:HyperLink ID="viewQuestion" runat="server" CssClass="btn bt" BackColor="#343A40" BorderStyle="None" ForeColor="White" NavigateUrl='<%# "/Teacher/ViewResult.aspx?sid=" + Eval("Email") %>'>
                                                                        <i class="bi bi-exclamation-circle" aria-hidden="true"></i> View Result
                                                                    </asp:HyperLink>
                                                                </ItemTemplate>

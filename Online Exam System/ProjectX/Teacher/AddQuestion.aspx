<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddQuestion.aspx.cs" Inherits="ProjectX.Teacher.AddQuestion" %>
...
<head runat="server">
    <title>Add Question - Online Examination System</title>
                                ...
                                <div class="col-xl-10">
                                    <div class="card">
                                        ...
                                        <div class="btn-group bg-danger">
                                            <asp:Button ID="btn_panelquestion" runat="server" Text="Add Question" CssClass="btn bt1 btn-info" BorderStyle="None" CausesValidation="False" BackColor="#343A40" />
                                        </div>
                                            ...
                                            <div class="tab-content pt-3">
                                                ...
                                                <div class="offset-2">
                                                    <div class="text-center">
                                                        <asp:Button Text="Add Question" type="submit" class="btn1 btn-primary" ID="savebtn" BorderStyle="None" ForeColor="White" OnClick="addQues" runat="server" />
                                                    </div>
                                                </div>

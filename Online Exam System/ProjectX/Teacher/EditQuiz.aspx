<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditQuiz.aspx.cs" Inherits="ProjectX.Teacher.EditQuiz" %>
...
<head runat="server">
    <title>Edit Quiz - Online Examination System</title>
                                ...
                                <div class="col-xl-11">
                                    <div class="card">
                                        ...
                                        <div class="btn-group bg-danger">
                                            <asp:Button ID="btn_paneleditexam" runat="server" Text="Edit Quiz" CssClass="btn bt1 btn-info" BorderStyle="None" CausesValidation="False" BackColor="#343A40" />
                                        </div>
                                            ...
                                            <div class="tab-content pt-3">
                                                ...
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-md-8 col-lg-9">
                                                        ...
                                                        <asp:RegularExpressionValidator ID="rev1" runat="server" ErrorMessage="* Enter Valid Duration!" ControlToValidate="quizDuration" ForeColor="red" ValidationExpression="^\d{1,45}$" Display="Dynamic"></asp:RegularExpressionValidator>
                                                ...
                                                <div class="offset-2">
                                                    <div class="text-center">
                                                        <asp:Button Text="Update" type="submit" class="btn1 btn-primary" ID="savebtn" BorderStyle="None" ForeColor="White" OnClick="editQuiz" runat="server" />
                                                    </div>
                                                </div>
